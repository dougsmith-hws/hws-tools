...
Nine suites, **437 assertions**. All drive the real application in headless
...
| **Persistence — client** | `persistence-client.test.js` | 73 | Gate C: save/load orchestration, debounce, single-flight, failure safety, status truthfulness, the pre-authentication path, Gate C.5 saved-buyer retrieval. **No database required** |
